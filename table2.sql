CREATE TABLE EMPLOYEE (
	...
	FirstName varchar(255) default "temp",
	LastName varchar(255) default "temp",
	StreetAddress varchar(255) default "temp",
	City varchar(255) default "temp",
	Zip varchar(255) default "temp",
	ShortState varchar(2) default "tp",
	PhoneNumber varchar(14) default "temp",
